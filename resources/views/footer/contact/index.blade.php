@extends('layout.app')
@section('pageTitle',trans('Contact List'))
    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                <div>
                    <a class="btn btn-sm btn-primary float-end" href="{{route(currentUser().'.contact.create')}}"><i class="bi bi-plus"></i></a>
                </div>
                <!-- table bordered -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    <a href="{{route(currentUser().'.contact.edit',encryptor('encrypt',$c->id))}}">
