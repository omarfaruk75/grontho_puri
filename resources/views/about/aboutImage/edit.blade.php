...
@section('pageTitle',trans('Edit About Page Image Page'))
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.aboutImage.update',encryptor('encrypt',$about->id))}}">
                                @csrf
                                @method('PATCH')
                                <input type="hidden" name="uptoken" value="{{encryptor('encrypt',$about->id)}}">
                                <div class="row">
