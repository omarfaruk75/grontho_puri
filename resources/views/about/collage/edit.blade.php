                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6 col-12">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="category_bn">
                                            ...
                                            <option value="কবিতা" {{ $collage->category=='কবিতা'?'selected':''}}>কবিতা</option>
                                            <option value="বই পুনঃমূল্যায়ন " {{ $collage->category=='বই পুনঃমূল্যায়ন '?'selected':''}}>বই পুনঃমূল্যায়ন </option>
                                            <option value="ছবি" {{ $collage->category=='ছবি'?'selected':''}}>ছবি</option>
                                            <option value="শিল্প" {{ $collage->category=='শিল্প'?'selected':''}}>শিল্প</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title_bn" class="form-control" value="{{ old('title_bn',$collage->title_bn)}}" name="title_bn">
