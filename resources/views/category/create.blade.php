                            ...
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.category.store')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <textarea type="text" id="category_en" class="form-control" value="{{ old('category_en')}}" name="category_en"></textarea> 
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <label for="category_bn">{{__('Category_BN')}}</label>
                                        <textarea type="text" id="category_bn" class="form-control" value="{{ old('category_bn')}}" name="category_bn"></textarea> 
                                    </div>
                                    <div class="col-md-6 col-12">
