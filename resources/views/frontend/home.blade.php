                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 ps-3">
                                            <h5 class="card-title mb-0 mt-0 fw-bold"> {{$front_right?->user?->name}} </h5>
                                    ...
                                    <p class="text-para-2">
                                        ...
                                        <b><a href="#" class="text-decoration-none ms-1"> See More</a></b></p>
                ...
                <div class="row">
                    @forelse($featured as $h)
                        ...
                        <div class="col-6 col-sm-6 col-md-8 col-lg-8 mt-3">
                            ...
                            <h6 class="mt-1 text-para-2">{!! $h?->{'title_'.session()->get('locale')} !!} </h6>
        ...
        <div class="row"> 
            ...
            @forelse($homeArticle as $h)
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="ad_img_3_text">{!! $h?->{'short_text_'.session()->get('locale')} !!}<b><a href="#" class="text-decoration-none">See More</a></b> </p>
                    </div>
                    <hr>
                </div>
            @empty
